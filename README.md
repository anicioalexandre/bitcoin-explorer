...
### `Uso`
O app está hospedado no GitHub Pages no link:
https://anicioalexandre.github.io/bitcoin-explorer
...
Para executar os testes, dentro da pasta correta do repositório (.../bitcoinExplorer):
```bash
npm test
```
